...
const Features = () => {
    return (
        <div>
            <section className=" sm:py-12 dark:bg-gray-100 text-gray-800">
	<div className="container p-6 border mx-auto space-y-8">
		<div className="space-y-2 text-center">
			<h2 className="text-3xl font-bold">Get Access To <br /> Artistic Exclusive Features</h2>
			<p className="font-serif text-sm text-gray-600">Artistic is built with many amazing and easy to use features already built to save additional app cost.</p>
		</div>
